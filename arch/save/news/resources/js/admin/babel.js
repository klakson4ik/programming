...
var CategoryEdit = /*#__PURE__*/function () {
  ...
  _createClass(CategoryEdit, [{
    ...
    value: function changeParent() {
      ...
      this.button.addEventListener("click", function () {
        _this.tree.style.display = "block";
      });

      for (var i = 0; i < this.plus.length; ++i) {
        this.plus[i].addEventListener("click", function (e) {
          var newText = e.currentTarget.parentNode.querySelector(".category-edit-branch-text").textContent;
          _this.tree.style.display = "";
          _this.newText.textContent = "new parent: " + newText;
          _this.newText.style.display = "block";
          _this.parentID.value = e.currentTarget.dataset.id;
        });
      }
    }
  }]);
...
if (new RegExp('/admin/category/edit/\\d+').test(document.location.pathname)) new CategoryEdit();
...
var Category = /*#__PURE__*/function () {
  function Category(root, element, text) {
    ...
    this.text = text; //        this.root = document.querySelector(".category-root"); 
  ...
  _createClass(Category, [{
          ...
          if (children !== null) {
            ...
            for (var j = 0; j < nodes.length; ++j) {
              if (nodes[j] !== e.currentTarget) {
                ...
                nodes[j].querySelector(_this2.text).style.color = "red";
              }
            }
    ...
    key: "addRoot",
    value: function addRoot(target) {
      var branchLastChild = this.root.querySelector(".category-root-element:last-child");
      var text = target.querySelector(".category-branch-text").textContent;
      var element = "<li class='category-root-element'>" + text + "</li>";
...
if (document.location.pathname === "/admin/category") new Category(".category-tree", "category-tree-element", ".category-branch-text");
if (new RegExp('/admin/category/edit/\\d+').test(document.location.pathname)) new Category(".category-edit-tree", "category-edit-tree-element", ".category-edit-branch-text");