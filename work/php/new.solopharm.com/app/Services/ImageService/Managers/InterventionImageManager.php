...
namespace App\Services\ImageService\Managers;
...
final class InterventionImageManager implements ImageManagerContract
{
	/**
	 * @var Image
	 */
	...
	/**
	 * Объект для работы непосредственно с конвертированием изображения
	 *
	 * @var AbstractEncoder
	 */
