...
class SoftFormPlantPageResource extends Resource
{
	public static string $model = 'App\Models\Pages\SoftFormPlantPage';

	public static string $title = 'Завод МЛФ';
				...
				Tabs::make([
					...
					Tab::make('Описание', [
						...
						Json::make(__('moonshine::form.field.data'), 'block_3_data')
							->fields([
								Textarea::make(__('moonshine::form.field.title'), 'value'),
							])->removable()
							->nullable()
							->hideOnIndex(),
					])
