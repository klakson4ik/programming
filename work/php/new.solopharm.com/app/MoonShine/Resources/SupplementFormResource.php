...
class SupplementFormResource extends Resource
{
    public static string $model = 'App\Models\SupplementForm';

    public static string $title = 'Формы выпуска';
        ...
        return [
            Block::make('form-container', [
                ...
                Image::make(__('moonshine::form.field.img'), 'img')
                    ->dir('/images/supplement_forms')
                    ->disk('public')
                    ->allowedExtensions(['jpg', 'png', 'webp', 'jpeg', 'svg'])
                    ->hint(__('moonshine::form.img.format') . ': 290x314.')
                    ->hideOnIndex()
                    ->removable(),
    ...
    {
        ImageEditor::resizeInAdmin(290, 314);
    }
