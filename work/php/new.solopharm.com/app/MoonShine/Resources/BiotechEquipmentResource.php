...
class BiotechEquipmentResource extends Resource
{
    public static string $model = 'App\Models\BiotechEquipment';
        ...
        return [
            Block::make('form-container', [
                ...
                Image::make(__('moonshine::form.field.img'), 'img')
                    ->dir('/images/biotech_equipments')
                    ->disk('public')
                    ->allowedExtensions(['jpg', 'png', 'webp', 'jpeg', 'svg'])
                    ->hint(__('moonshine::form.img.format') . ': 360x209.')
                    ->hideOnIndex()
                    ->removable(),
    ...
    {
        ImageEditor::resizeInAdmin(360, 209);
    }
