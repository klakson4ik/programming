...
class LabdirectionResource extends Resource
{
    public static string $model = 'App\Models\Labdirection';

    public static string $title = 'Направления в лаборатории';
        ...
        return [
            Block::make('form-container', [
                ...
                Image::make(__('moonshine::form.field.img'), 'img')
                    ->dir('/images/labdirections')
                    ->disk('public')
                    ->allowedExtensions(['jpg', 'png', 'webp', 'jpeg', 'svg'])
                    ->hint(__('moonshine::form.img.format') . ': 535x376.')
                    ->hideOnIndex()
                    ->removable(),
    ...
    {
        ImageEditor::resizeInAdmin(535, 376);
    }
