...
class SolidplantSystemResource extends Resource
{
    public static string $model = 'App\Models\SolidplantSystem';

    public static string $title = 'Solidplant системы';
        ...
        return [
            Block::make('form-container', [
                ...
                Image::make(__('moonshine::form.field.img'), 'img')
                    ->dir('/images/solidplant_systems')
                    ->disk('public')
                    ->allowedExtensions(['jpg', 'png', 'webp', 'jpeg', 'svg'])
                    ->hint(__('moonshine::form.img.format') . ': 360x280.')
                    ->hideOnIndex()
                    ->removable(),
    ...
    {
        ImageEditor::resizeInAdmin(360, 280);
    }
