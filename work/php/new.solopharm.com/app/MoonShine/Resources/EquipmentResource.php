...
{
    public static string $model = 'App\Models\Equipment';
        ...
        return [
            Block::make('form-container', [
                ...
                Image::make(__('moonshine::form.field.img'), 'img')
                    ->dir('/images/equipments')
                    ->disk('public')
                    ->allowedExtensions(['jpg', 'png', 'webp', 'jpeg', 'svg'])
                    ->hint(__('moonshine::form.img.format') . ': 458x574.')
                    ->hideOnIndex()
                    ->removable(),
                TextArea::make('Форма выпуска', 'form')
                    ->hideOnIndex(),
                TextArea::make('Производитель', 'manufacturer')
                    ->hideOnIndex(),
                TextArea::make('Производительность', 'performance')
                    ->hideOnIndex(),
    ...
    {
        ImageEditor::resizeInAdmin(458, 574);
    }
