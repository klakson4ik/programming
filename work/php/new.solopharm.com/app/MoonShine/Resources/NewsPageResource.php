...
{
    public static string $model = 'App\Models\Pages\NewsPage';

    public static string $title = 'Пресс-центр';
            ...
            Block::make('form-container', [
                Tabs::make([
                    Tab::make(__('moonshine::form.tab.main'), [
                        ...
                        TinyMce::make(__('moonshine::form.field.title'), 'title'),
                    ...
                    Tab::make(__('moonshine::form.tab.content'), [
                        Text::make(__('moonshine::form.field.tab'), 'tab_1')
                            ->hideOnIndex(),
                        Text::make(__('moonshine::form.field.tab'), 'tab_2')
                            ->hideOnIndex(),
                        Text::make(__('moonshine::form.field.btn'), 'btn_caption')
                            ->hideOnIndex(),
                        Text::make(__('moonshine::form.field.action'), 'btn_url')
                            ->hideOnIndex(),
                    ])
                ]),
