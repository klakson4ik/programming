...
class MarketPageResource extends Resource
{
    public static string $model = 'App\Models\Pages\MarketPage';

    public static string $title = 'Экспортные рынки';

    public function fields(): array
    {
        return [
            Block::make('Экспортные рынки', [
                Tabs::make([
                    ...
                    Tab::make('Описание', [
                        TinyMce::make(__('moonshine::form.field.text'), 'block_1_text')
                            ->hideOnIndex(),
                    ...
                    Tab::make('Партнерство', [
                        ...
                        Image::make(__('moonshine::form.field.img'), 'block_2_img')
                            ...
                            ->hint(__('moonshine::form.img.format') . ': 427x285.')
                            ->hideOnIndex()
                            ->removable(),
    ...
    {
        ImageEditor::resizeInAdmin(427, 285, 'block_2_img');
    }
    ...
    {
        StorageHelper::delete($item->block_2_img);
    }
}
