...
class CosmetologyDetailPage extends StaticModel
{
	// TODO: ???
	...
	public static function getCommon()
	{
		return [
			...
			'calendar' => [
				...
				'days' => Calendar::getCalendarData(Cosmetology::isActive()->whereBetween('date', Calendar::getRangeMonth())->get()->toArray())
			]
		];
	}
